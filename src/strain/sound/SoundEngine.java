...
public class SoundEngine {
	 ...
	 * 
	 * @param musicIndex
	 *            The index of the sound effect file.
	 */
	 ...
	 * 
	 * @param soundFile
	 *            The location of the sound effect file, relative to the sound
	 *            resource location.
	 */
	...
	/**
	 * Plays the music file associated with a music index. The file is loaded if
	 * it hasn't yet been loaded, and then it is played. If a music file is
	 * already playing when this method is called, it is stopped.
	 * 
	 * @param musicIndex
	 *            The index of the music file.
	 */
	 ...
	 *            The index of the music file.
	 * @param restart
	 *            Whether to restart the music track if the music is already
	 *            playing.
	 */
	 ...
	 * 
	 * @param musicFile
	 *            The location of the music file, relative to the sound resource
	 *            location.
	 * @param restart
	 *            Whether to restart the music if the requested track is already
	 *            playing.
	 */
	 ...
	 * the sound effect file has already been loaded, this method has no effect.
	 * 
	 * @param effectIndex
	 *            The index of the sound effect file.
	 */
	 ...
	 * 
	 * @param volume
	 *            The new volume for sound effects.
	 */
