...
class SoundPlayer implements Runnable {
	...
	/**
	 * Allocates a new SoundPlayer with given data. The data is copied from the
	 * given array to negate access issues.
	 * 
	 * @param soundData
	 *            The sound data that is to be played.
	 * @param volume
	 *            The volume to play the sound data at.
	 * @param loop
	 *            Whether to loop play back until stopped.
	 */
